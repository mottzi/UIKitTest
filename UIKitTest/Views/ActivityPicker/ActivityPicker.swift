...
class ActivityPicker: UIViewController, MKMapViewDelegate
{
    ...
    let annotationControl: MapAnnotationControl = MapAnnotationControl()
    ...
    private func setupSubViews()
    {
        ...
        annotationControl.setup(map: self)
    }
